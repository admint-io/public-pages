...
window.color_scheme_to_ftd=async function color_scheme_to_ftd(colorSchemeData) {
    ...
    return new Promise(function(resolve, reject) {
        ...
        fetchUiComponents(domainName).then((result)=>{
            ...
            if("colorSchemeUrl" in result.values[0]){
                fetchColorScheme(result.values[0].colorSchemeUrl).then((colorSchemeData)=>{
                    console.log("fetchColorScheme() promise resolved");
                    color_scheme_to_ftd(colorSchemeData).then((resultColorsObj)=>{
                        ...
                        console.error("Promise rejected : color_scheme_to_ftd(), Reason : ",error);
                      });           
                }).catch(error => {
